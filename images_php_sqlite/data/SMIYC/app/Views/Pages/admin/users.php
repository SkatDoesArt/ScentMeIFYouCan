                        ...
                        <tr>
                            ...
                            <td>
                                <div class="user-actions">
                                    ...
                                    <a href="<?= base_url('admin/edit/user/' . $user->id) ?>" title="Éditer utilisateur" aria-label="Éditer utilisateur">
                                    ...
                                    <?php if ($user->inGroup('admin')): ?>
                                        <form action="<?= base_url('admin/edit/role/' . $user->id . '/user') ?>" method="post">
                                            <?= csrf_field() ?>
                                    ...
                                    <?php else: ?>
                                        <form action="<?= base_url('admin/edit/role/' . $user->id . '/admin') ?>" method="post">
                                            <?= csrf_field() ?>
                                    ...
                                    <form action="<?= base_url('admin/delete/user/' . $user->id) ?>" method="post" onsubmit="return confirm('Supprimer cet utilisateur ?');">
                                        <?= csrf_field() ?>
                                        <button type="submit" title="Supprimer utilisateur" aria-label="Supprimer utilisateur">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                                                <path d="M3 6h18" />
                                                <path d="M8 6v14" />
                                                <path d="M16 6v14" />
