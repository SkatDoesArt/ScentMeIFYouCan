    ...
    <div class="main">
        ...
        <div class="container b-container" id="b-container">
            <form class="form" id="b-form" method="POST" action="<?= base_url(); ?>auth/login/">
                ...
                <input name="mail" class="form__input" type="text" placeholder="Email">
                <input name="password" class="form__input" type="password" placeholder="Mot de passe"><a
                    class="form__link">Mot
                    de passe oublié?</a>
        ...
        <div class="switch" id="switch-cnt">
            ...
            <div class="switch__container is-hidden" id="switch-c2">
                ...
                <p class="switch__description description">Entrez vos informations personnelles pour créer votre compte
                </p>
