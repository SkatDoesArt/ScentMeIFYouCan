    ...
    <div class="main">
      ...
      <div class="container b-container" id="b-container">
        <form class="form" id="b-form" method="POST" action="<?php echo base_url(relativePath: 'auth/login'); ?>">
          ...
          <input name="mail" class="form__input" type="text" placeholder="Email">
          <input name="password" class="form__input" type="password" placeholder="Mot de passe"><a class="form__link">Mot de passe oublié?</a>
