            ...
            <section class="empty-cart" style="text-align:center; padding:3rem 1rem;">
                <div class="empty-card"
                    ...
                    <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap">
                        ...
                        <a href="<?= base_url('catalogue') ?>" class="btn secondary" style="min-width:160px;">Parcourir le
                            catalogue</a>
                    </div>
                </div>
            </section>
            ...
            <section class="empty-cart" style="text-align:center; padding:3rem 1rem;">
                <div class="empty-card"
                    ...
                    <div style="margin-top:6px;">
                        ...
                        <div style="display:flex;gap:8px;justify-content:center;margin-top:5%;flex-wrap:wrap;">
                            <a class="chip" href="<?= base_url('catalogue/encens') ?>"
                                style="padding:8px 12px;border-radius:999px;background:white;color:black;border:1px solid black;text-decoration:none;">Encens</a>
                            <a class="chip" href="<?= base_url('catalogue?categorie=Unisexe') ?>"
                                style="padding:8px 12px;border-radius:999px;background:white;color:black;border:1px solid black;text-decoration:none;">Pour
                                tous !</a>
                            <a class="chip" href="<?= base_url('catalogue?filtre=parfums') ?>"
                                style="padding:8px 12px;border-radius:999px;background:white;color:black;border:1px solid black;text-decoration:none;">Parfums</a>
                            <a class="chip" href="<?= base_url('catalogue/creme') ?>"
                                style="padding:8px 12px;border-radius:999px;background:white;color:black;border:1px solid black;text-decoration:none;">Crèmes</a>
                        </div>
                        <style>
                            a.chip:hover {
                        ...
                        <?php foreach ($items as $item):
                            ...
                            <div class="cart-row">
                                <div class="col-article product-flex">
                                    <a
                                        href="<?= base_url('catalogue/product/' . ($produit->id_produit ?? $produit->id ?? '')) ?>">
                ...
                <aside class="summary-sidebar">
                    <div class="users-card" style="padding:18px;">
                        ...
                        <div style="margin-top:6px; font-size:1.15rem; color:#2c7aeb;">Total :
                            <strong><?= number_format($totalPrix, 2, ',', ' ') ?> €</strong>
                        </div>
