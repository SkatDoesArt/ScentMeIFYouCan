...
<header id="header">
            ...
            <div id="nav-buttons">
                <a href="<?= base_url() ?>auth/login">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
                         class="min-h-iconLarge min-w-iconLarge stroke-[0.125rem]" height="2rem" width="2rem"
                         aria-hidden="true">
                        <path fill="currentColor" fill-rule="evenodd"
    ...
    <?php if ($showList): ?>
        <nav id="nav-list">
            ...
            <a href="<?= base_url() ?>catalogue?categorie=Unisexe"><span class="categorie"
                                                                         role="link">Unisexe</span></a>
