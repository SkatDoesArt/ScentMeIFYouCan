...
<header id="header">
        ...
        <nav id="nav-upper">
            ...
            <?php if ($showSearch): ?>
                <form class="recherche" role="search" action="<?= base_url('catalogue/search') ?>" method="get">
                    ...
                    <input type="search" id="search" name="q" placeholder="Rechercher un produit, une marque" inputmode="search"/>
                    <button type="submit" style="background: none; border: none; cursor: pointer;">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" height="2rem" width="2rem" aria-hidden="true">
                            <path fill="currentColor" fill-rule="evenodd" d="M22.067 15a7 7 0 1 1-14 0 7 7 0 0 1 14 0m-1.155 6.844a9 9 0 1 1 1.365-1.456q.045.039.088.082l4.482 4.482c.488.488.567 1.2.176 1.59s-1.102.312-1.59-.176l-4.482-4.482z" clip-rule="evenodd"></path>
                        </svg>
                    </button>
                </form>
            <?php endif; ?>
            ...
            <div id="nav-buttons">
                ...
                <?php if ($showCart): ?>
                    <a href="<?= base_url('cart') ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" height="2rem" width="2rem" aria-hidden="true">
                            <path fill="currentColor" fill-rule="evenodd" d="M21.997 11q.002-.23.002-.5C22 6.91 19.313 4 16 4s-6 2.91-6 6.5q0 .27.003.5H6.094a2 2 0 0 0-1.984 2.254l1.665 13A2 2 0 0 0 7.76 28h16.478a2 2 0 0 0 1.984-1.747l1.657-13A2 2 0 0 0 25.893 11zM20 10.5l-.001.42c-.167.017-.371.031-.623.043C18.59 11 17.52 11 16 11s-2.59 0-3.376-.037a12 12 0 0 1-.622-.043l-.002-.42C12 7.861 13.938 6 16 6s4 1.861 4 4.5M6.094 13 7.76 26h16.478l1.657-13z" clip-rule="evenodd"></path>
                        </svg>
                    </a>
                <?php endif; ?>
                
                <?php if (function_exists('auth') && auth()->loggedIn()): ?>
                    <a href="<?= base_url('auth/logout') ?>" class="logout-link" title="Se déconnecter">
    ...
    <?php if ($showList): ?>
        <nav id="nav-list">
            <a href="<?= base_url() ?>"><span class="categorie" role="link">Accueil</span></a>
