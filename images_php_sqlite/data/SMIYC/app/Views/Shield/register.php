    ...
    <div class="main">
        <div class="container a-container" id="a-container">
            <form class="form" id="a-form" method="POST" action="<?= url_to('register') ?>">
                ...
                <div class="form__group" style="margin-top:12px; text-align:left; width:100%;">
                    <label style="display:flex;align-items:center;gap:10px;justify-content:center;">
                        ...
                        <span class="cgu">J'accepte les <a href="<?= base_url('cgu') ?>" target="_blank">Conditions Générales d'Utilisation (CGU)</a></span>
                    </label>
                    <?php if (session('errors.accept_cgu')): ?>
                        <div class="error-feedback">
                            <?= esc(session('errors.accept_cgu')) ?>
                        </div>
                    <?php endif ?>
                </div>
                ...
                <p class="form__span" style="margin-top: 20px;">
                    Vous avez déjà un compte ? <a href="login" class="form__link"
                                                  style="border: none;">Connectez-vous</a>
                </p>
