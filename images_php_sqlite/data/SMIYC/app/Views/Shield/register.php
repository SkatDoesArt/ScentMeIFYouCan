    ...
    <div class="main">
        <div class="container a-container" id="a-container">
            <form class="form" id="a-form" method="POST" action="<?= url_to('register') ?>">
                ...
                <input name="username" class="form__input" type="text" placeholder="Nom d'utilisateur" value="<?= old('username') ?>" required>
                ...
                <input name="password" class="form__input" type="password" inputmode="text" autocomplete="new-password" placeholder="Mot de passe" required>
                ...
                <input name="password_confirm" class="form__input" type="password" inputmode="text" autocomplete="new-password" placeholder="Confirmer le mot de passe" required>
